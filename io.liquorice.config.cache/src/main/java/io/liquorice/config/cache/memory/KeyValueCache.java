...
/**
 * A purely in-memory {@link io.liquorice.config.cache.CacheLayer}, backed by a standard {@link Map}.
 */
public class KeyValueCache extends AbstractCacheLayer implements CacheLayer {
    ...
    /**
     * As the {@link io.liquorice.config.cache.memory.KeyValueCache} is an in-memory only cache, this method is unused
     *
     * @param path
     *            ignored
     * @param encoding
