...
public interface CacheLayer extends Iterable {
    ...
    /**
     * Flushes all data stored in this cache to its write-through {@link io.liquorice.config.core.cache.CacheLayer},
     * then clears
     * 
     * @throws CacheInitializationException
    ...
    /**
     * The {@link io.liquorice.config.core.cache.CacheLayer} to forward requests to.
     *
     * <p>
     * Every {@link io.liquorice.config.core.cache.CacheLayer} must have write-through cache assigned. When in doubt,
     * use the {@link io.liquorice.config.core.cache.memory.BlackHoleCache}. The write through cache will be used in two
     * places:
     * <ul>
     ...
     * <li>If {@link #flush} is called, this {@link io.liquorice.config.core.cache.CacheLayer} will push its elements to
     * the write-through cache</li>
     * </ul>
     *
    ...
    /**
     * Purge a single element from this {@link io.liquorice.config.core.cache.CacheLayer}.
     * 
     * @param key
    ...
    /**
     * Store a single element in this {@link io.liquorice.config.core.cache.CacheLayer}.
     * 
     * @param key
    ...
    /**
     * Store a group of elements in this {@link io.liquorice.config.core.cache.CacheLayer}.
     * 
     * @param elementMap
    ...
    /**
     * Convenience method for initializing this {@link io.liquorice.config.core.cache.CacheLayer} with already existing
     * data.
     *
     * @param path
     *            A {@link java.nio.file.Path} representing a file or directory to bulk load elements from
     * @param encoding
     *            The character encoding to read any files as
     * @throws CacheWarmingException
     *             if the {@link io.liquorice.config.core.cache.CacheLayer} could not be warmed
     */
     ...
     * 
     * @param inputStream
     *            An {@link java.io.InputStream} to bulk load elements from
     * @param encoding
