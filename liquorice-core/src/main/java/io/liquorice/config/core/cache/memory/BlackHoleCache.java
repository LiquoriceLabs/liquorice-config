...
/**
 * A dummy {@link io.liquorice.config.core.cache.CacheLayer}, perfectly suited as an end-of-the-line write-through.
 *
 * <p>
 * This cache does not store any data and is immutable. Its sole purpose is to be a low-overhead
 * {@link io.liquorice.config.core.cache.CacheLayer} that goes at the end of your set of caches. This allows all
 * {@link io.liquorice.config.core.cache.CacheLayer}s to be agnostic as to their position in the hierarchy. E.g.
 *
 * <pre>
 * {@code
 * // Create CacheLayers
...
public class BlackHoleCache extends AbstractCacheLayer implements CacheLayer {
    ...
    /**
     * This method does nothing because this {@link io.liquorice.config.core.cache.CacheLayer} does not store elements
     */
    @Override
    public void clear() {
    ...
    /**
     * Return a default {@link java.lang.String} value
     *
     * @param key
     *            ignored
     * @param defaultValue
    ...
    /**
     * This method does nothing but return null because this {@link io.liquorice.config.core.cache.CacheLayer} does not
     * store elements.
     *
     * @param key
     *            ignored
