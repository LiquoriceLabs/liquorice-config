...
public interface CacheLayer extends Iterable {
    ...
    /**
     * Flushes all data stored in this cache to its write-through {@link io.liquorice.config.cache.CacheLayer},
     * then clears
     * 
     * @throws CacheInitializationException
    ...
    /**
     * The {@link io.liquorice.config.cache.CacheLayer} to forward requests to.
     *
     * <p>
     * Every {@link io.liquorice.config.cache.CacheLayer} must have write-through cache assigned. When in doubt,
     * use the {@link io.liquorice.config.cache.memory.BlackHoleCache}. The write through cache will be used in two
     * places:
     * <ul>
     ...
     * <li>If {@link #flush} is called, this {@link io.liquorice.config.cache.CacheLayer} will push its elements to
    ...
    /**
     * Purge a single element from this {@link io.liquorice.config.cache.CacheLayer}.
     * 
     * @param key
    ...
    /**
     * Store a single element in this {@link io.liquorice.config.cache.CacheLayer}.
     * 
     * @param key
    ...
    /**
     * Store a group of elements in this {@link io.liquorice.config.cache.CacheLayer}.
     * 
     * @param elementMap
    ...
    /**
     * Convenience method for initializing this {@link io.liquorice.config.cache.CacheLayer} with already existing
     * data.
     *
     * @param path
     ...
     *             if the {@link io.liquorice.config.cache.CacheLayer} could not be warmed
     */
