...
/**
 * Convenience factory for creating {@link io.liquorice.config.utils.logging.Log}s.
 */
public final class LogFactory {
    ...
    /**
     * Get a copy of the {@link java.util.logging.Formatter} used by {@link io.liquorice.config.utils.logging.Log}s
